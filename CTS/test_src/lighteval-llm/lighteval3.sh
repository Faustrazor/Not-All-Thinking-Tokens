MODEL=/data1/users/yuanh/saves/electric/qwen2.5-14B-Instruct/math_first_train_4096
NUM_GPUS=8
...
target=/data0/users/yuanh/lighteval-llm/qwen2.5-14B/math_first_train_2
