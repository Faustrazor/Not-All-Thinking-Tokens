MODEL=/data1/users/yuanh/saves/qwen2.5-14B-Instruct/sft_full/math220k_first_longskip_80_4096
NUM_GPUS=8
...
target=/data0/users/yuanh/lighteval-llm/qwen2.5-14B/longskip_80_4
