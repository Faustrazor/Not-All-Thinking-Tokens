...
llm_lingua = PromptCompressor(
    model_name="/data0/models/Qwen2.5-7B-Instruct"    
)
...
with open(f'/data0/users/yuanh/CoT-compression/math220k_llmlingua_qwen7B/llmlingua_nonRM_actual_{args.rate}.txt', 'w', encoding='utf-8') as f:
...
num = str(args.rate*100)
with open(f'/data0/users/yuanh/CoT-compression/math220k_llmlingua_qwen7B/math_llmlingua_nonRM_{num}.json', 'w', encoding='utf-8') as f:
